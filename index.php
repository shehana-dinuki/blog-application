...
if ($search !== '') {
    ...
    $stmt = $pdo->prepare("
        SELECT blogpost.id, blogpost.title, blogpost.category,
               blogpost.content, blogpost.cover_image,
...
<div class="container"
     style="max-width: 500px; margin: 40px auto 24px;">
...
<section class="container why-blog">
  ...
  <div class="why-blog-heading reveal">
    ...
    <p>
      Every developer has something worth writing about.
    ...
    <div class="card feature-card-violet reveal">
      ...
      <p class="meta"
         style="margin-top: 10px;
                font-family: var(--font-body);
                color: var(--text-muted);">
        Turn your thoughts into meaningful stories.
      </p>
    </div>
    ...
    <div class="card feature-card-blue reveal reveal-delay-1">
      ...
      <p class="meta"
         style="margin-top: 10px;
                font-family: var(--font-body);
                color: var(--text-muted);">
        Explore topics and deepen your knowledge.
      </p>
    ...
    <div class="card feature-card-teal reveal reveal-delay-3">
      ...
      <p class="meta"
         style="margin-top: 10px;
                font-family: var(--font-body);
                color: var(--text-muted);">
        Showcase your knowledge, creativity, and skills.
      </p>
    ...
    <div class="card feature-card-amber reveal">
      ...
      <p class="meta"
         style="margin-top: 10px;
                font-family: var(--font-body);
                color: var(--text-muted);">
        Improve your writing with every story.
      </p>
    ...
    <div class="card"
      ...
      <?php if ($search !== ''): ?>
        ...
        <p class="meta"
          ...
          Nothing matches "<?= htmlspecialchars($search) ?>".
      ...
      <?php else: ?>
        ...
        <p class="meta"
          ...
          This is where new posts will appear.
  ...
  <?php else: ?>
    ...
    <div style="display: grid;
      ...
      <?php foreach ($blogs as $blog): ?>
        ...
        <?php
        $coverIndex = $blog['id'] % count($coverStyles);
        ?>

        <a href="blog.php?id=<?= $blog['id'] ?>"
           class="card card-with-image <?= $borderStyles[$coverIndex] ?>">

          <?php if (
              !empty($blog['cover_image']) &&
              file_exists(__DIR__ . '/uploads/' . $blog['cover_image'])
          ): ?>
          ...
          <?php else: ?>
            ...
            <div class="card-cover <?= $coverStyles[$coverIndex] ?>">
              <?= $coverSymbols[$coverIndex] ?>
            </div>

          <?php endif; ?>

          <span class="tag <?= $categoryTagClass[$blog['category']] ?? 'tag-violet' ?>">
